...
def heisenberg():
    ...
    heisenberg_mpo = MPO(L, physical_dim=2)
...
def ising():
    ...
    ising_mpo = MPO(L, physical_dim=2)
    ...
    ising = Broomstick(ising_mps, ising_mpo, max_bond_dim=16)
...
def vbs():
    ...
    vbs = Broomstick(vbs_mps, vbs_mpo, max_bond_dim=32)
...
def aklt():
    ...
    aklt_mpo = MPO(L, physical_dim=phys_dim, mapping=mapping)
    ...
    dmrg = Broomstick(MPS(L, phys_dim), aklt_mpo, max_bond_dim=2)
